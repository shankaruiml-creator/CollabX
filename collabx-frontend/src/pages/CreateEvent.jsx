...
const CreateEvent = () => {
  ...
  const handleCreate = (e) => {
    ...
    formData.append("collegeId", currentUser.collegeId || currentUser.id);
      ...
      <div className="container-fluid flex-grow-1 d-flex align-items-center justify-content-center p-3 overflow-auto">
        ...
        <div className="col-lg-7">
          <div className="card border-0 shadow-sm rounded-4 bg-white p-4 p-md-4 px-lg-5 h-100">
            <div className="mb-3">
              <h3 className="fw-bold mb-0" style={{ color: "var(--text-main)", fontSize: "1.4rem" }}>Publish Opportunity</h3>
              <p className="text-muted small mb-0">Fill in the details to list your event on <strong className="text-dark">Collab</strong><strong className="text-primary">X</strong></p>
            </div>
